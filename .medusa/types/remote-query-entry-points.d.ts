...
export type Product = {
  ...
  sales_channels?: Maybe<Array<Maybe<SalesChannel>>>;
  vendor_link?: Maybe<LinkMarketplaceModuleVendorProductProduct>;
  vendor?: Maybe<Vendor>;
};
...
export type Order = {
  ...
  promotion?: Maybe<Promotion>;
  vendor_link?: Maybe<LinkMarketplaceModuleVendorOrderOrder>;
  vendor?: Maybe<Vendor>;
};
...
export type Vendor = {
  ...
  admins: Array<Maybe<VendorAdmin>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
  order_link?: Maybe<Array<Maybe<LinkMarketplaceModuleVendorOrderOrder>>>;
  orders?: Maybe<Array<Maybe<Order>>>;
  product_link?: Maybe<Array<Maybe<LinkMarketplaceModuleVendorProductProduct>>>;
  products?: Maybe<Array<Maybe<Product>>>;
};

export type VendorAdmin = {
  __typename?: 'VendorAdmin';
  id: Scalars['ID']['output'];
  first_name?: Maybe<Scalars['String']['output']>;
  last_name?: Maybe<Scalars['String']['output']>;
  email: Scalars['String']['output'];
  vendor: Array<Maybe<Vendor>>;
  created_at: Scalars['DateTime']['output'];
  updated_at: Scalars['DateTime']['output'];
  deleted_at?: Maybe<Scalars['DateTime']['output']>;
};
...
export type LinkMarketplaceModuleVendorOrderOrder = {
  __typename?: 'LinkMarketplaceModuleVendorOrderOrder';
...
export type LinkMarketplaceModuleVendorProductProduct = {
  __typename?: 'LinkMarketplaceModuleVendorProductProduct';
  vendor_id: Scalars['String']['output'];
  product_id: Scalars['String']['output'];
  product?: Maybe<Product>;
  createdAt: Scalars['String']['output'];
...
declare module '@medusajs/framework/types' {
  interface RemoteQueryEntryPoints {
    ...
    vendor_order: LinkMarketplaceModuleVendorOrderOrder
    vendor_product: LinkMarketplaceModuleVendorProductProduct
  }
}